...
namespace HR_Application_CO_OP_HOS.Controllers
{
    public class EmployeeTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeTypeID,TypeName,Description")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeTypeID,TypeName,Description")] EmployeeType employeeType)
        {
            if (ModelState.IsValid)
            {
