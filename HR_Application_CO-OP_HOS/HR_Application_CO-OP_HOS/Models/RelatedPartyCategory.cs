...
namespace HR_Application_CO_OP_HOS.Models
{
    ...
    public partial class RelatedPartyCategory
    {
        public int ID { get; set; }
        public string RelatedPartyCategoryName { get; set; }
        public Nullable<int> RelatedPartyTypeID { get; set; }
        public string RelatedPartyCategoryCode { get; set; }
        public Nullable<int> RelatedPartyGrade { get; set; }
        public string RelatedPartyCategoryDescription { get; set; }
